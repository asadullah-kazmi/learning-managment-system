...
const AcademyDashboard: React.FC<AcademyDashboardProps> = ({ params }) => {
  ...
  // Mock academy data based on slug
  useEffect(() => {
    // Simulate API call to fetch academy data
    setTimeout(() => {
      const mockAcademyData = {
        slug: params.academySlug,
        name: `${
          params.academySlug.charAt(0).toUpperCase() +
          params.academySlug.slice(1)
        } Academy`,
        email: `admin@${params.academySlug}.com`,
        status: "active",
        isVerified: true,
        totalStudents: 156,
        totalTeachers: 12,
        ...
        totalRevenue: 45678,
        completionRate: 87.5,
        description: "Excellence in education and learning",
        phone: "+92 300 1234567",
        address: "123 Education Street, Karachi, Pakistan",
      };

      setAcademyData(mockAcademyData);
      setLoading(false);
    }, 1000);
  }, [params.academySlug]);
